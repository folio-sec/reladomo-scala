...
/**
  ...
  */
trait BiTemporalTransactionalObjectFinder[TxObject <: BiTemporalTransactionalObject,
  ...
  case class ListFinder[
      TxObject <: BiTemporalTransactionalObject,
      TxObjectList <: BiTemporalTransactionalList[TxObject, MithraTxObject],
      MithraTxObject <: MithraDatedTransactionalObject
  ](
      currentList: TxObjectList
  ) extends BiTemporalTransactionalList[TxObject, MithraTxObject] {
