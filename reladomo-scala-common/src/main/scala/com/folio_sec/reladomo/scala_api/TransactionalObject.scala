...
/**
  ...
  */
trait TransactionalObject extends TransactionalObjectBase {
  ...
  /**
    ...
    */
  protected def savedUnderlying: com.gs.fw.common.mithra.MithraTransactionalObject
  ...
  def delete()(implicit tx: Transaction): Unit = {
    underlying.delete()
  }

  def cascadeDelete()(implicit tx: Transaction): Unit = {
    underlying.cascadeDelete()
  }
